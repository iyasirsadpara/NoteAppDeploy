...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100">
      {/* Header */}
      <header className="bg-gradient-to-r from-green-950 to-green-600 shadow-lg">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-4xl font-bold text-white mb-2">Yasir Personal Notes</h1>
          <p className="text-green-100">Use this webapp to make good notes</p>
        </div>
      </header>
