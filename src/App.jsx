    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="bg-gradient-to-r from-blue-950   to-indigo-600 shadow-lg">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="text-blue-100">Capture your thoughts and ideas</p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Add New Note</h2>
          <form onSubmit={addNote} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 rounded-lg transition duration-300 transform hover:scale-105 shadow-md"
            >
              Add Note
            </button>
          </form>
          ...
          {notes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {notes.map((note) => (
                <  div
                  key={note.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition duration-300 transform hover:-translate-y-1"
                >
                  ...
                  <p className="text-gray-600 mb-4 leading-relaxed">{note.description}</p>
